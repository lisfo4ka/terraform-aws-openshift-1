resource "aws_launch_configuration" "master" {
  ...
  iam_instance_profile = "${var.create_iam_profiles ? coalesce(var.master_node_iam_profile_name, aws_iam_instance_profile.master.name) : var.master_node_iam_profile_name}"
